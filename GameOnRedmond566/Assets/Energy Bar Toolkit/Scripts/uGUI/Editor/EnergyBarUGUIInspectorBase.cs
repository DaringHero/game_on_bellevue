...
public class EnergyBarUGUIInspectorBase : EnergyBarInspectorBase {
    ...
    protected SerializedProperty labelInheritOpacity;
    ...
    public override void OnEnable() {
        ...
        labelInheritOpacity = serializedObject.FindProperty("labelInheritOpacity");
...
//        //EditorGUILayout.EndHorizontal();
    ...
    protected void FieldLabel2() {
        ...
        using (MadGUI.EnabledIf((target as EnergyBarUGUIBase).label != null)) {
            using (MadGUI.Indent()) {
                MadGUI.PropertyField(labelInheritOpacity, "Inherit Opacity");
