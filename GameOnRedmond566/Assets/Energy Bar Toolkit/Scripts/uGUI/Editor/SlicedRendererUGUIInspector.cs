...
[CustomEditor(typeof(SlicedRendererUGUI))]
public class SlicedRendererUGUIInspector : EnergyBarUGUIInspectorBase {
    ...
    private SerializedProperty spriteBarMinSize;
...
//    private readonly AnimBool followEffectAnimBool = new AnimBool();
    ...
    private SlicedRendererUGUI renderer;
